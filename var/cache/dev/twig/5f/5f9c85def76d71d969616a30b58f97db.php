    ...
    <table class=\"table table-striped\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            ((twig_get_attribute($this->env, $this->source, $context["user"], "roles", [], "any", false, false, false, 22)) ? (print (twig_escape_filter($this->env, json_encode(twig_get_attribute($this->env, $this->source, $context["user"], "roles", [], "any", false, false, false, 22)), "html", null, true))) : (print ("")));
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
...
{% endblock %}
", "user/index.html.twig", "C:\\Users\\Acer\\proj - Copie\\templates\\user\\index.html.twig");
    }
}
