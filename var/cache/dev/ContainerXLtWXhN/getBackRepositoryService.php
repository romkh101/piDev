 ...
 */
class getBackRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BackRepository' shared autowired service.
     *
     * @return \App\Repository\BackRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BackRepository.php';

        return $container->privates['App\\Repository\\BackRepository'] = new \App\Repository\BackRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
