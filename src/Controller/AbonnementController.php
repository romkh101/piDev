...
class AbonnementController extends AbstractController
{
    ...
    public function index(AbonnementRepository $abonnementRepository,SerializerInterface $serializerInterface): Response
    {
       $abonnements=$abonnementRepository->findAll();
       $json=$serializerInterface->serialize($abonnements,'json');
...
/**
     * @Route("/users/{userId}/abonnements/{abonnementId}", name="assign_abonnement_to_user")
     */
